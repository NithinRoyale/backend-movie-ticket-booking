...
//	Add Initial Movie And Theater Data 
	...
	public void run(String... args) throws Exception {
		...
		Movie movie11 = new Movie( "Brahmastra 1: Shiva", 2022, "Action-Drama", "Hindi", "https://www.themoviedb.org/t/p/original/4kZW6qBBf8djV7Gbe2vpJVUbNR8.jpg","https://image.tmdb.org/t/p/original/f2910ixwlkmTnzoBobfUvvHze3Z.jpg","https://www.youtube.com/embed/BUjXzrgntcY?si=MqYn5mST73n7MewC");
		...
		Theater theater1 = new Theater("Grand Cinema", 200, Arrays.asList("10:00 AM", "1:00 PM", "4:00 PM"), 1, Arrays.asList("17-05-2025", "18-05-2025", "19-05-2025"), "https://th.bing.com/th/id/OIP.4EXPLgZqFe8PFaWhMNFYkgHaJg?w=220&h=283&c=8&rs=1&qlt=90&o=6&dpr=2&pid=3.1&rm=2");
		Theater theater2 = new Theater("Elite Theater", 150, Arrays.asList("11:00 AM", "2:00 PM", "5:00 PM"), 2, Arrays.asList("20-05-2025", "21-05-2025", "22-05-2025"), "https://th.bing.com/th/id/OIP.aU_VnMXhUVC8cwzsiY4LbgHaFZ?w=292&h=213&c=8&rs=1&qlt=90&o=6&dpr=2&pid=3.1&rm=2");
		Theater theater3 = new Theater("Galaxy Multiplex", 300, Arrays.asList("9:00 AM", "12:00 PM", "3:00 PM"), 3, Arrays.asList("23-05-2025", "24-05-2025", "25-05-2025"), "https://th.bing.com/th/id/OIP.b8WvZgdajytlosm15GrNyAHaFj?w=288&h=216&c=8&rs=1&qlt=90&o=6&dpr=2&pid=3.1&rm=2");
		Theater theater4 = new Theater("Cine World", 250, Arrays.asList("10:30 AM", "1:30 PM", "4:30 PM"), 3, Arrays.asList("26-05-2025", "27-05-2025", "28-05-2025"), "https://th.bing.com/th/id/OIP.yvn6mxHjKkSohMYnPCkPPAHaE4?w=128&h=104&c=7&bgcl=b61f8b&r=0&o=6&dpr=2&pid=13.1");
